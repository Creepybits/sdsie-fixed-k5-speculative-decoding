...
Reads telemetry/ablation_results.json (produced by benchmark_ablation.py)
...
Usage:
    ...
    python3 plot_ablation_results.py --telemetry telemetry/ablation_results.json --out assets
"""
...
def main():
    ...
    parser.add_argument(
        "--telemetry",
        type=Path,
        default=Path(__file__).resolve().parent.parent / "telemetry" / "ablation_results.json",
